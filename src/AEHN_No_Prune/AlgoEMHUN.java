...
//			System.out.println(dataset.toString());
		...
		insertionSort(itemsToKeepBoth, utilityBinArrayLU);
...
//			}
	...
	public void printStats() {
		...
		System.out.println("Positive: "+ListPositive.size()+" Negative: "+ListNegative.size()+ " Both : "+ListNegativeAndPositive.size());
